...
export default function ({id, title, text, removeNote, updateNote}){
        ...
        <Fade duration={500}>
            <div>
                <div ref={noteElement} className="shadow-md flex flex-col border dark:hover:border-neutral-700 dark:focus-within:border-neutral-700 border-neutral-300 p-2 rounded focus-within:border-neutral-400 hover:border-neutral-400 dark:border-neutral-800 overflow-hidden">
                    <input ref={titleElement} onChange={() => updateNote(id, titleElement.current.value, textElement.current.value)} type="text" placeholder="Title..." spellCheck="false" autoComplete="off" className="bg-transparent dark:placeholder:text-neutral-800 placeholder:italic text-xl text-neutral-800 dark:text-white focus:outline-none font-semibold" defaultValue={title}/>
                    <textarea ref={textElement} onChange={() => updateNote(id, titleElement.current.value, textElement.current.value)} rows="7" placeholder="Text..." spellCheck="false" autoComplete="off" className="bg-transparent dark:placeholder:text-neutral-800 placeholder:italic text-lg text-neutral-800 dark:text-white focus:outline-none resize-none scrollbar-thin dark:scrollbar-thumb-neutral-700 scrollbar-thumb-neutral-400 scrollbar-track-transparent" defaultValue={text}></textarea>
